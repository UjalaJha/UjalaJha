  ...
  return (
    <main onMouseMove={handleMouseMove}>
        ...
        <div className="container pt-[60px] md:pt-[60px] pb-20">
          ...
          <section className="mt-10 grid md:grid-cols-12 gap-8 items-center">
            <div className="order-1 md:order-1 md:col-span-7">
              <h1 className="font-display text-4xl md:text-6xl font-semibold tracking-tight bg-gradient-to-r from-brand via-brand-2 to-brand-3 bg-clip-text text-transparent animate-fade-in pb-1 md:pb-2">
                Hey, I am Ujala!
              </h1>
      ...
      <section id="skills" className="container py-16">
        <h2 className="text-2xl md:text-3xl font-semibold py-5">My Expertise</h2>
      ...
      <section id="contact" className="container py-17">
